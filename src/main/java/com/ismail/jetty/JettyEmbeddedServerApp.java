 ...
 */
@Slf4j
public class JettyEmbeddedServerApp
{
    // Resource path pointing to where the WEBROOT is
    private String jettyHome = "/web/";

    private int port;

    private Server server;

    public JettyEmbeddedServerApp(String jettyHome,  int jettyPort)
    {
    ...
    private void enableEmbeddedJspSupport(ServletContextHandler servletContextHandler) throws IOException
    {
        ...
        servletContextHandler.addBean(new JettyEmbeddedJspStarter(servletContextHandler));
    ...
    {
        URL indexUri = this.getClass().getResource(jettyHome);
        if (indexUri == null)
        {
            throw new FileNotFoundException("Unable to find resource " + jettyHome);
        }
    ...
    {
        String jettyHome = "/web/";
        int jettyPort = 9080;

        JettyEmbeddedServerApp main = new JettyEmbeddedServerApp(jettyHome, jettyPort);
        main.start();
